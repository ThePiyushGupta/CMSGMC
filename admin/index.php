	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark ">
		...
		<div class="collapse navbar-collapse text-white" id="navbarNav">
			<ul class="nav nav-pills justify-content-end">
				...
				<li class="nav-item">
				<a class="nav-link text-white  active" href="http://localhost/cms/admin/">Engineer Login</a>
				</li>
				<li class="nav-item">
					<a class="nav-link text-white" href="http://localhost/cms/supervisor/">Supervisor Login</a>
				</li>
			</ul>
		</div>
	</nav>
