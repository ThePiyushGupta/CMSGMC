	...
	if (strlen($_SESSION['login']) == 0) {
	    ...
	    if (isset($_POST['submit'])) {
	        ...
	        $complaintdetials = $_POST['complaindetails'];
			  ...
			  $teststr = "insert into tblcomplaints(userId,category,subcategory,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintdetials','$compfile')";
			// echo $teststr;
	        move_uploaded_file($_FILES["compfile"]["tmp_name"], "complaintdocs/" . $_FILES["compfile"]["name"]);
	        $query = mysqli_query($con, "insert into tblcomplaints(userId,category,subcategory,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintdetials','$compfile')");
