...
if($num>0)
{
 $con=mysqli_query($con,"update admin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['slogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Supervisor Change Password</h3>
							</div>
